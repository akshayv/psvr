...
\newline
\newline
My family and friends for their feedback and support through this period.
\cleardoublepage
...
\begin{tabular}{ |c|c|c|c|c| }
  ...
  \renewcommand{\arraystretch}{0.7}% Tighter
   \begin{tabular}{@{}c@{}}Worst Case \\ Time Complexity\end{tabular} & $O(np^2/m)$ & $O(n^3/m)$ & $O(n^3/m)$ & $O(n^3)$ \\
  \hline  
    \renewcommand{\arraystretch}{0.7}% Tighter
  \begin{tabular}{@{}c@{}}Worst Case \\ Space Complexity\end{tabular} & $O(np/m)$ & $O(n^2/m)$ &$O(n^2/m)$& $O(n^2)$ \\
  \hline
  ...
  Local Optimization & No & Yes & Yes & Yes \\
   \hline
  \renewcommand{\arraystretch}{0.7}% Tighter
  \begin{tabular}{@{}c@{}}Kernel Matrix \\ Approximation\end{tabular} & Yes & No & No & No \\
  \hline  
    \renewcommand{\arraystretch}{0.7}% Tighter
   \begin{tabular}{@{}c@{}}Effective with \\ Small Clusters\end{tabular} & Yes & No & No & No \\
  \hline
\end{tabular}
  \renewcommand{\arraystretch}{1}% Tighter
\ \\
...
The SMW (the Sherman-Morrison-Woodbury formula) is not directly applicable to our case, it needs to be modified to account for the additional matrix factor, E, which is fortunately a diagonal matrix. So, $\Sigma^{-1}u$ can be equated to:
 \begin{gather} 
\Sigma^{-1}u = (\delta+QE)^{-1}u \approx (\delta+HH^TE)^{-1}u\\
= \delta^{-1}u - \delta^{-1}H(I + H^T \delta^{-1}EH)^{-1}H^TE \delta^{-1}u\\
= \delta^{-1}u - \delta^{-1}H(GG^{T})^{-1}H^TE \delta^{-1}u
\end{gather}
...
\newline\newline
\begin{tikzpicture}
\begin{axis}[title={(a) SARCOS},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,xmajorgrids=true,grid style=dashed,] 
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[title={(b) AIMPEAK},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,xmajorgrids=true,grid style=dashed,] 
\addplot[color=red,mark=square*,]
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[title={(c) HADSST},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,
    xmajorgrids=true,
    grid style=dashed,
] 
\addplot[color=red,mark=square*,]
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[title={(d) Housing},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,
    xmajorgrids=true,
    grid style=dashed,
] 
\addplot[color=red,mark=square*,]
...
\begin{tikzpicture}
 \begin{groupplot}[group style={group size= 2 by 1},height=7cm,width=8.5cm]
  \nextgroupplot [title={(a) Communication Overhead},xlabel={Machines used},xmin=0, xmax=60,ymin=0, ymax=25,xtick={0,10,20,30,40,50, 60},ytick={0,5,10,15,20, 25},legend style={at={(0.5,0.5)},anchor=west},xmajorgrids=true,grid style=dashed,] 
\addplot[color=red,mark=square*,]
    coordinates {
    ...
    \nextgroupplot [title={(b) Synchronization Overhead},xlabel={Machines used},,xmin=0, xmax=60,ymin=0, ymax=40,xtick={0,10,20,30,40,50, 60},ytick={0, 10,20, 30, 40},legend pos=north west,xmajorgrids=true,grid style=dashed,] 
...
\end{tikzpicture}
\newline
\centerline{Figure 4.2. Overheads incurred for datasets}
\newline\newline
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis} [title={(c) HADSST},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,xmajorgrids=true,grid style=dashed,] 
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis} [title={(d) Housing},xlabel={Machines used},ylabel={Speedup},xmin=0, xmax=60,ymin=0, ymax=60,xtick={0,10,20,30,40,50, 60},ytick={0,10,20,30,40,50, 60},legend pos=north west,xmajorgrids=true,grid style=dashed,] 
...
\end{tikzpicture}
\ \\
\centerline{Figure 4.3. Speedup for various datasets excluding sequential component.}
\newline\newline
...
\bibitem{libsvm}J. C. Platt {\em LIBSVM: A library for support vector machines} 2011: ACM Transactions on Intelligent Systems and Technology (TIST), Volume 2 Issue 3, Article No. 27	
